...
// Requests BeFrank URI info that was found by background/send.js and fills send form:
function getBeFrankURIfromBackground() {
  var request = {greeting: "BeFrank befrank-wallet-rpc Fill Send Page"};
